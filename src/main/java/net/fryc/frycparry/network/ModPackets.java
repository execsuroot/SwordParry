...
import net.fryc.frycparry.network.s2c.InformClientAboutParryWindowS2CPacket;
...
public class ModPackets {
    ...
    public static final Identifier INFORM_CLIENT_ABOUT_PARRY_WINDOW_ID = new Identifier(FrycParry.MOD_ID, "inform_client_about_parry_window_id");
    ...
    public static void registerS2CPackets(){
        ...
        ClientPlayNetworking.registerGlobalReceiver(INFORM_CLIENT_ABOUT_PARRY_WINDOW_ID, InformClientAboutParryWindowS2CPacket::receive);
    }
}
